...
$email_from='atendimento@nerde.com.br';	// Substitua essa linha pelo seu e-mail@seudominio
}else {
...
mail($email,$assunto, $telefone,$mens,$headers, "-r".$email_from); 
...
mail($email,$mensagem,$telefone, $headers, "-r".$email_from); 
